...
namespace DBFirstApproachCRUD.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        private Task<Student> GetStudent(string StudentName, string Password)
        {
            return _context.Students.FirstOrDefaultAsync(u => u.StudentName == StudentName && u.Password == Password);
        }
        ...
        public async Task<IActionResult> Login(string StudentName, string Password)
        {
            ...
            var user = await GetStudent(StudentName, Password);
